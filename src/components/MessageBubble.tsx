  ...
  if (isUser) {
    return (
      <div className="flex animate-slide-up justify-end gap-3">
        <div className="max-w-[85%] rounded-2xl rounded-tr-md bg-user-bubble px-4 py-2.5 text-[0.95rem] leading-relaxed text-foreground whitespace-pre-wrap break-words">
          {message.content}
        </div>
    ...
    <div className="group flex animate-slide-up gap-3">
      ...
      <div className="min-w-0 flex-1 pt-0.5">
        ...
        {message.content ? (
          ...
          />
        ) : !message.reasoning && !message.searching && streaming ? (
          <ThinkingDots />
        ) : null}
